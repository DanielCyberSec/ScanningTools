...
if [ "$(echo $?)" == "0" ]; then
	...
	while true; do
		echo -e "$rojoNegrita 1$sinColor) Escaneo puertos abiertos, serviciosos y versiones (${rojoNegrita}lento pero sigiloso$sinColor)"
      		echo -e "$rojoNegrita 2$sinColor) Escaneo puertos abiertos (${rojoNegrita}lento pero sigiloso$sinColor)"
		echo -e "$rojoNegrita 3$sinColor) Escaneo puertos abiertos (${rojoNegrita}rápido pero ruidoso$sinColor)"
      		echo -e "$rojoNegrita 4$sinColor) Escaneo puertos abiertos con generación de archivos (${rojoNegrita}all$sinColor) (${rojoNegrita}rápido pero ruidoso$sinColor)"
		echo -e "$rojoNegrita 5$sinColor) Escaneo de vulnerabilidades en puertos abiertos de manera agresiva y generación de arhivo XML (${rojoNegrita}rapido y ruidoso$sinColor)"
      		echo -e "$rojoNegrita 6$sinColor) Salir"
